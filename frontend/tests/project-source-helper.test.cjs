...
test('公共源码助手可以读取项目根目录和前端目录文件', () => {
  assert.match(readProjectFile('pom.xml'), /<artifactId>doorhandlecatch-parent<\/artifactId>/)
  assert.match(readProjectFile('legacy-service', 'pom.xml'), /<artifactId>legacy-service<\/artifactId>/)
